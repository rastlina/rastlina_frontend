...
const WatchAndBuy = () => (
  // Replaced solid color with a custom radial-like gradient to match the reference image
  <section className="py-16 text-white bg-gradient-to-b from-[#0e5c66] via-[#083a42] to-[#042226] relative overflow-hidden">
    
    {/* Optional subtle top highlight to mimic the light source in the image */}
    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-64 bg-[#2396a8] opacity-20 blur-[100px] pointer-events-none rounded-full" />
    ...
    <div className="container-custom relative z-10">
      ...
      <div className="flex overflow-x-auto gap-4 pb-4 md:grid md:grid-cols-4 md:pb-0 no-scrollbar snap-x px-4 md:px-0 -mx-4 md:mx-0">
        {[livingImg, officeImg, balconyImg, heroImage].map((img, i) => (
            <div key={i} className="min-w-[200px] md:min-w-0 snap-center aspect-[9/16] relative bg-black/20 rounded-xl overflow-hidden group cursor-pointer border border-white/10 shadow-xl">
